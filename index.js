...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    let twenties = array[i].years.split("-");
    if (twenties[0] >= 1900 && twenties[0] <= 2000) {
...
function addArtist(array) {
  array.push({
    id: 20,
    name: `Nadeem Khan`,
    years: `1988 - 01/22/2021`,
    genre: `Web Design`,
    nationality: `Fijian`,
    bio: `New to coding, been training myself to become ambidextrous over the past few years!`,
  });
  return array;
}
